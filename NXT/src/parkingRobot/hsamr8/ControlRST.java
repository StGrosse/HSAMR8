...
public class ControlRST implements IControl {
    ...
    private void exec_VWCTRL_ALGO(){
		...
		if(curve!=dest.no){
		steuerL = (int)(Math.signum(speed[0])*(Math.abs(speed[0])-offsetAngVelPerPercentL)/angVelPerPercentL); //mit w_wheel=angVelPerPercent*power+offsetAngVelPerPercent (lineare Näherung)
